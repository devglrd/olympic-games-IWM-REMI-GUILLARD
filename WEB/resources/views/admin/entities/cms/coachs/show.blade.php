    ...
    <div class="content sm-gutter">
        <div class="container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Voir un coach</li>
            </ol>
            <div>
                <div class="row mb-3 w-50">
                    <div class="col-md-3 mr-2">
                        <form action="{{ route('admin.coachs.destroy', $user->id) }}"
                              method="POST">
                            <input type="hidden" value="DELETE" name="_method">
                            {{ csrf_field() }}
                            <button type="submit"
                                    class="delete btn btn btn-danger">Supprimer</button>
                        </form>
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('admin.coachs.notif', $user->id) }}" class="btn btn-primary">Notifié</a>
                    </div>
                ...
                <div class="row">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default"
                                             aria-required="true">
                                            {{ $user->sexe === \App\Models\User\User::MALE ? 'Homme' : 'Femme' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12">
                                        @if($user->getActivitys)
                                            <div class="form-group form-group-default"
                                                ...
                                                {{ implode(', ', $user->getActivitys->map(function($item){
                                        ...
                                        @if($user->getSkills)
                                            <div class="form-group form-group-default"
                                                ...
                                                {{ implode(', ', $user->getSkills->map(function($item){
                                                    return $item->name;
                                                })->toArray()) }}
                                            </div>
                                        @endif
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="card card-white">
                            <div class="card-header ">
                                <div class="card-title">Photo du coach
                                </div>
                            </div>
                            <div class="card-block">
