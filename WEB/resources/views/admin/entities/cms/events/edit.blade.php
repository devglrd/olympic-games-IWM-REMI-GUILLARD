        ...
        <div class="container">
            <form class="row g-3"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control" id="inputEmail4" value="{{ $event->name }}">
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="timepicker" name="time" value="{{ $event->time }}">
                </div>


                <div class="col-md-12">
                    <label for="inputPassword4" class="form-label">Description</label>
                    <textarea name="content" class="form-control" id="" cols="30" rows="10" placeholder="{{ $event->content }}"
