    ...
    <div class="content sm-gutter">
        <div class="container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">#OP{{str_pad($option->id, 5, '0', STR_PAD_LEFT)}}</li>
            </ol>
            <form action="{{ action([\App\Http\Controllers\Admin\Cms\OptionController::class, 'update'], $option->id) }}"
                  method="POST"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                   value="{{ $option->name }}" placeholder="Nom de l'option"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                   value="{{ $option->value }}" placeholder="Valeur de l'option"
                                                   required>
                                        </div>
                                    </div>
                                </div>
