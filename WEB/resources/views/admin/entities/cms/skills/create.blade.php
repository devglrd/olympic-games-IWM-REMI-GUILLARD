    ...
    <div class="content sm-gutter">
        <div class="container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Ajouter un nouveau trait de caractère</li>
            </ol>
            <form action="{{ action([\App\Http\Controllers\Admin\Cms\SkillController::class, 'store']) }}" method="POST"
