                        ...
                        <div class="col-xl-5 col-lg-6 ">
                            <div class="card card-transparent">
                                <div class="card-block">
                                    ...
                                    <a href="{{ action([\App\Http\Controllers\SskController::class, 'create']) }}"
                        ...
                        @foreach($data AS $key => $skill)
                            ...
                            <tr>
                                <td class="v-align-middle semi-bold">
                                    #SF{{ $skill->id ? str_pad($skill->id, 5, '0', STR_PAD_LEFT) : 'XXX' }}
                                </td>
                                ...
                                <td style="width:20%" class="v-align-middle d-flex">
                                    <a href="{{ route('admin.softskill.edit', $skill->id) }}"
                                       class="btn btn-primary mr-3">
                                        Editer
                                    </a>
                                    <form action="{{ route('admin.softskill.destroy', $skill->id) }}"
                                          method="POST">
