    ...
    <div class="content sm-gutter">
        <div class="container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">#SF{{str_pad($skill->id, 5, '0', STR_PAD_LEFT)}}</li>
            </ol>
            <form action="{{ action([\App\Http\Controllers\SskController::class, 'update'], $skill->id) }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} form-group-default required"
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                   value="{{ $skill->name }}" placeholder="Nom"
                                                   required>
                                        </div>
                                    </div>
                                </div>
