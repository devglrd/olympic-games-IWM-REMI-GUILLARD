...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.index = function () {
    ...
    UsersService.prototype.getByEmailAndPass = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var passHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UsersService.prototype.create = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getByEmail(payload.email)];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            throw new common_1.NotAcceptableException('User with provided email already created.');
                        }
                        return [4 /*yield*/, this.userRepository.save(this.userRepository.create(payload))];
